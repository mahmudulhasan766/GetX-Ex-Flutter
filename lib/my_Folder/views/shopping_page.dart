...
import 'package:shopping/my_Folder/controllers/shopping_controller.dart';
import 'package:shopping/my_Folder/views/details_cart.dart';
        ...
        child: Column(
          children: [
            ...
            GetX<CartController>(builder: (controller) {
              return Text(
                'Total amount: \$ ${controller.getCartTotal()}',
